...
public class UpdateDailyExerciseHistoryFunction
{
    ...
    public async Task<HttpResponseData> UpdateAsync(
        [HttpTrigger(AuthorizationLevel.Anonymous, "put", Route = "dailyexercisehistory/update")] HttpRequestData req,
        FunctionContext executionContext)
    {
        var logger = executionContext.GetLogger("DailyExerciseHistory_UpdateDailyExerciseHistoryFunction");
        logger.LogInformation("Procesando solicitud para actualizar un DailyExerciseHistory.");
        ...
        try
        {
            ...
            var result = await _service.UpdateDailyExerciseHistoryAsync(objRequest, userId, ip, invocationId);
            if (!result.Success)
            {
        ...
        {
            logger.LogError(ex, "Error al actualizar DailyExerciseHistory.");
