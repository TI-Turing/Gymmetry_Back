...
public class UpdateBrandFunction
{
        ...
        FunctionContext executionContext)
    {
        ...
        logger.LogInformation("Procesando solicitud para actualizar una marca.");
        ...
        try
        {
            ...
            var result = await _brandService.UpdateBrandAsync(objRequest, userId, ip, invocationId);
            if (!result.Success)
            {
        ...
        {
            logger.LogError(ex, "Error al actualizar marca.");
