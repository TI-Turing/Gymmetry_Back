...
namespace Gymmetry.Functions.GymPlanSelectedModuleFunction
{
    public class DeleteGymPlanSelectedModuleFunction
    {
        ...
        public async Task<ApiResponse<Guid>> RunAsync([HttpTrigger(AuthorizationLevel.Anonymous, "delete", Route = "gymplanselectedmodule/{id:guid}")] HttpRequest req, Guid id)
        {
