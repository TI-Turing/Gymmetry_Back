...
public class UpdateGymPlanSelectedModuleFunction
{
        ...
        FunctionContext executionContext)
    {
        ...
        logger.LogInformation("Procesando solicitud para actualizar un GymPlanSelectedModule.");
        ...
        try
        {
            ...
            var result = await _service.UpdateGymPlanSelectedModuleAsync(objRequest, userId, ip, invocationId);
            if (!result.Success)
            {
        ...
        {
            logger.LogError(ex, "Error al actualizar GymPlanSelectedModule.");
