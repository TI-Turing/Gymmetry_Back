...
public class AddGymFunction
{
    ...
    [Function("AddGymFunction")]
    public async Task<ApiResponse<Guid>> AddAsync([HttpTrigger(AuthorizationLevel.Function, "post", Route = "gym/add")] HttpRequest req)
    {
        ...
        _logger.LogInformation("Procesando solicitud para agregar un Gym.");
        try
        {
        ...
        {
            _logger.LogError(ex, "Error al agregar Gym.");
            return new ApiResponse<Guid>
            {
                Success = false,
