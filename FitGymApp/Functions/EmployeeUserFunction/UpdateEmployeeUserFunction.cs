...
public class UpdateEmployeeUserFunction
{
        ...
        FunctionContext executionContext)
    {
        ...
        logger.LogInformation("Procesando solicitud para actualizar un EmployeeUser.");
        ...
        try
        {
            ...
            var result = await _service.UpdateEmployeeUserAsync(objRequest, userId, ip, invocationId);
            if (!result.Success)
            {
        ...
        {
            logger.LogError(ex, "Error al actualizar EmployeeUser.");
