...
namespace Gymmetry.Functions.ScheduleFunction
{
    public class DeleteScheduleFunction
    {
        ...
        public DeleteScheduleFunction(IScheduleService service)
        {
            _service = service;
        }

        [Function("Schedule_DeleteScheduleFunction")]
        public async Task<HttpResponseData> RunAsync(
            [HttpTrigger(AuthorizationLevel.Anonymous, "delete", Route = "schedule/{id:guid}")] HttpRequestData req,
            ...
            Guid id)
        {
            ...
            {
                logger.LogError(ex, "Error al eliminar Schedule.");
