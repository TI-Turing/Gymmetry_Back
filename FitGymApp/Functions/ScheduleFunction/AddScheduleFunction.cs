...
public class AddScheduleFunction
{
    ...
    [Function("AddScheduleFunction")]
    public async Task<ApiResponse<Guid>> AddAsync([HttpTrigger(AuthorizationLevel.Function, "post", Route = "schedule/add")] HttpRequest req)
    {
        ...
        _logger.LogInformation("Procesando solicitud para agregar un Schedule.");
        try
        {
            ...
            var result = _service.CreateSchedule(objRequest);
            if (!result.Success)
            {
                return new ApiResponse<Guid>
                {
        ...
        {
            _logger.LogError(ex, "Error al agregar Schedule.");
            return new ApiResponse<Guid>
            {
                Success = false,
