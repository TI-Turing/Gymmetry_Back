...
public class UpdateMachineFunction
{
    private readonly IMachineService _service;

    public UpdateMachineFunction(IMachineService service)
    {
        _service = service;
    }
        ...
        FunctionContext executionContext)
    {
        ...
        logger.LogInformation("Procesando solicitud para actualizar una Machine.");
        ...
        try
        {
            ...
            var objRequest = JsonConvert.DeserializeObject<UpdateMachineRequest>(requestBody);
            var validationResult = ModelValidator.ValidateModel<UpdateMachineRequest, Guid>(objRequest, StatusCodes.Status400BadRequest);
            ...
            var result = await _service.UpdateMachineAsync(objRequest, userId, ip,invocationId);
            if (!result.Success)
            {
        ...
        {
            logger.LogError(ex, "Error al actualizar Machine.");
