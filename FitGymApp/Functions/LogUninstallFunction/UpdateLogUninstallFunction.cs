...
public class UpdateLogUninstallFunction
{
        ...
        FunctionContext executionContext)
    {
        ...
        logger.LogInformation("Procesando solicitud para actualizar un LogUninstall.");
        ...
        try
        {
            ...
            var result = await _service.UpdateLogUninstallAsync(objRequest, userId, ip, invocationId);
            if (!result.Success)
            {
        ...
        {
            logger.LogError(ex, "Error al actualizar LogUninstall.");
