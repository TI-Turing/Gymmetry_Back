...
public class UpdateEmployeeTypeFunction
{
    ...
    public async Task<HttpResponseData> UpdateAsync(
        [HttpTrigger(AuthorizationLevel.Anonymous, "put", Route = "employeetype/update")] HttpRequestData req,
        FunctionContext executionContext)
    {
        var logger = executionContext.GetLogger("EmployeeType_UpdateEmployeeTypeFunction");
        logger.LogInformation("Procesando solicitud para actualizar un EmployeeType.");
        ...
        try
        {
            ...
            var result = await _service.UpdateEmployeeTypeAsync(objRequest, userId, ip, invocationId);
            if (!result.Success)
            {
        ...
        {
            logger.LogError(ex, "Error al actualizar EmployeeType.");
