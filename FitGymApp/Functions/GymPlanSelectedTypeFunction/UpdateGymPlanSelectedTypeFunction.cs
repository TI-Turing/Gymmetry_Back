...
public class UpdateGymPlanSelectedTypeFunction
{
    ...
    [Function("UpdateGymPlanSelectedTypeFunction")]
    public async Task<ApiResponse<Guid>> UpdateAsync([HttpTrigger(AuthorizationLevel.Function, "put", Route = "gymplanselectedtype/update")] HttpRequest req)
    {
        ...
        try
        {
            ...
            var result = _service.UpdateGymPlanSelectedType(objRequest);
            if (!result.Success)
            {
                return new ApiResponse<Guid>
                {
