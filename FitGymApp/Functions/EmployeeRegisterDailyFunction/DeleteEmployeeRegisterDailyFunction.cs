...
namespace Gymmetry.Functions.EmployeeRegisterDailyFunction
{
    public class DeleteEmployeeRegisterDailyFunction
    {
        ...
        public async Task<ApiResponse<Guid>> RunAsync([HttpTrigger(AuthorizationLevel.Anonymous, "delete", Route = "employeeregisterdaily/{id:guid}")] HttpRequest req, Guid id)
        {
