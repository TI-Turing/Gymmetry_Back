...
namespace FitGymApp.Functions.RoutineAssignedFunction
{
    public class DeleteRoutineAssignedFunction
    {
        ...
        [Function("DeleteRoutineAssignedFunction")]
        public async Task<ApiResponse<Guid>> RunAsync([HttpTrigger(AuthorizationLevel.Function, "delete", Route = "routineassigned/{id:guid}")] HttpRequest req, Guid id)
        {
            ...
            {
                _logger.LogError(ex, "Error al eliminar RoutineAssigned.");
                return new ApiResponse<Guid>
                {
                    Success = false,
