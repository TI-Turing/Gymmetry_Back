...
public class UpdateJourneyEmployeeFunction
{
    ...
    public async Task<ApiResponse<Guid>> UpdateAsync([HttpTrigger(AuthorizationLevel.Function, "put", Route = "journeyemployee/update")] HttpRequest req)
    {
        ...
        _logger.LogInformation("Procesando solicitud para actualizar un JourneyEmployee.");
        ...
        {
            _logger.LogError(ex, "Error al actualizar JourneyEmployee.");
            return new ApiResponse<Guid>
            {
                Success = false,
