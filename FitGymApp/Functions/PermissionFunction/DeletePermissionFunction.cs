...
namespace Gymmetry.Functions.PermissionFunction
{
    public class DeletePermissionFunction
    {
        ...
        public DeletePermissionFunction(IPermissionService service)
        {
            _service = service;
        }
        ...
        public async Task<HttpResponseData> RunAsync(
            ...
            Guid id)
        {
            var logger = executionContext.GetLogger("Permission_DeletePermissionFunction");
            logger.LogInformation($"Procesando solicitud de borrado para Permission {id}");
            ...
            {
                logger.LogError(ex, "Error al eliminar Permission.");
