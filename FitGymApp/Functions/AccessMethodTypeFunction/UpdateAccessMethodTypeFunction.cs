...
public class UpdateAccessMethodTypeFunction
{
        ...
        FunctionContext executionContext)
    {
        ...
        logger.LogInformation("Procesando solicitud para actualizar un AccessMethodType.");
        ...
        try
        {
            ...
            var result = await _service.UpdateAccessMethodTypeAsync(objRequest, userId, ip, invocationId);
            if (!result.Success)
            {
        ...
        {
            logger.LogError(ex, "Error al actualizar AccessMethodType.");
