...
{
    public class CommentUpdateFunction
    {
        private readonly ILogger<CommentUpdateFunction> _logger;
        private readonly ICommentService _commentService;

        public CommentUpdateFunction(ILogger<CommentUpdateFunction> logger, ICommentService commentService)
        {
            _logger = logger;
            ...
            FunctionContext executionContext)
        {
            ...
            var dto = JsonSerializer.Deserialize<CommentUpdateRequestDto>(body);
            if (dto == null)
            {
