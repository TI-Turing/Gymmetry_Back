...
namespace FitGymApp.Domain.Migrations
{
    ...
    [Migration("20250723124302_RemoveEmailVerifiedAndSeedVerificationType")]
    partial class RemoveEmailVerifiedAndSeedVerificationType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitGymApp.Domain.Models.PaymentAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FitGymApp.Domain.Models.PaymentAttemptStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FitGymApp.Domain.Models.UserOTP", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FitGymApp.Domain.Models.VerificationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b1a1e1c1-1111-4e1a-8e1a-111111111111"),
                            CreatedAt = new DateTime(2025, 7, 23, 12, 43, 2, 219, DateTimeKind.Utc).AddTicks(8185),
                            IsActive = true,
                            Nombre = "Email"
                        },
                        new
                        {
                            Id = new Guid("b2b2e2c2-2222-4e2a-8e2a-222222222222"),
                            CreatedAt = new DateTime(2025, 7, 23, 12, 43, 2, 219, DateTimeKind.Utc).AddTicks(8376),
                            IsActive = true,
                            Nombre = "Phone"
                        });
                });
            ...
            modelBuilder.Entity("FitGymApp.Domain.Models.Branch", b =>
                {
                    ...
                    b.HasOne("FitGymApp.Domain.Models.Daily", null)
                        .WithMany("Branches")
            ...
            modelBuilder.Entity("FitGymApp.Domain.Models.PaymentAttempt", b =>
                {
                    ...
                    b.HasOne("FitGymApp.Domain.Models.GymPlanSelected", "GymPlanSelected")
                        ...
                        .HasForeignKey("FitGymApp.Domain.Models.PaymentAttempt", "GymPlanSelectedId");

                    b.HasOne("FitGymApp.Domain.Models.Plan", "Plan")
                        .WithOne("PaymentAttempt")
                        .HasForeignKey("FitGymApp.Domain.Models.PaymentAttempt", "PlanId");

                    b.HasOne("FitGymApp.Domain.Models.PaymentAttemptStatus", "Status")
                        .WithMany("PaymentAttempts")
